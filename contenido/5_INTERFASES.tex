...
\end{figure}
\vspace{-5pt}
\textit{Nota.} Elaboración propia. Cada flecha indica el protocolo de comunicación y la dirección del flujo de datos. (Sustituir caratula.png por diagrama\_interfases.png)
