...
% Aquí debes incluir tu imagen del diagrama de despliegue:
% \begin{figure}[H]
% \caption{Diagrama de Despliegue del Sistema Smart-Park}
% \centering
% \includegraphics[width=0.95\textwidth]{imagenes/diagrama_despliegue.png}
% \end{figure}
...
\midrule
Cámaras IP & Red local de cada estacionamiento & Cámaras que transmiten imágenes JPEG/MJPEG vía HTTP/HTTPS al motor de visión artificial. \\
\bottomrule
\end{tabularx}
\end{table}
