...
\begin{figure}[H]
\caption{Diagrama de Componentes, Vista Lógica de Smart-Park}
\centering
\includegraphics[width=0.95\textwidth]{imagenes/figuras/figura_3.png}
\end{figure}
\vspace{-5pt}
...
\begin{figure}[H]
\caption{Diagrama de Secuencia, Flujo de Reserva, Ingreso, Cobro y Salida de un Vehículo}
\centering
\includegraphics[width=0.95\textwidth]{imagenes/figuras/figura_4.png}
\end{figure}
\vspace{-5pt}
\textit{Nota.} Elaboración propia.
...
\begin{figure}[H]
\caption{Diagrama de Infraestructura Física de Smart-Park}
\centering
\includegraphics[width=0.95\textwidth]{imagenes/figuras/figura_5.png}
\end{figure}
\vspace{-5pt}
\textit{Nota.} Elaboración propia.
