...
\caption[]{Roles y Responsabilidades del Equipo (continuación)} \\
\toprule
\textbf{Rol} & \textbf{Responsable} & \textbf{Responsabilidades específicas} \\
\midrule
\endhead
...
\textit{Nota.} Todos los integrantes participaron en todas las etapas del proyecto con una contribución equitativa del 100\,\%. Los roles descritos indican el área de mayor aporte técnico de cada miembro.
